...
class VendingMachine:
    ...
    """
    "*** YOUR CODE HERE ***"
    def __init__(self,product,sale):
    ...
    def vend(self):
        ...
        if self.balance == self.sale:
            self.num -= 1
            self.balance -= self.sale
            return 'Here is your {0}.'.format(self.product)
        elif self.balance < self.sale:
            return 'You must add ${0} more funds.'.format(self.sale - self.balance)
        else:
            self.num -= 1
            res = 'Here is your {0} and ${1} change.'.format(self.product,self.balance - self.sale)
            self.balance = 0
            return res
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        plus = Mint.current_year - self.year - 50
        return self.cents + (0 if plus <= 0 else plus)
